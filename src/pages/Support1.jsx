...
import { 
  ...
  ChevronRight, Scale, ShieldCheck, ShoppingCart, QrCode, Lock
} from 'lucide-react';
      ...
      <main className="flex-1 min-w-0">
        ...
        <section id="terms" className="mb-24 scroll-mt-40 border-t border-gray-100 pt-16">
            ...
            <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm space-y-8 text-slate-600">
                ...
                {/* [MỚI] Điều 5: Cam kết bảo mật thông tin */}
                <div className="flex gap-5">
                    <div className="bg-cyan-100 p-2.5 h-fit rounded-full text-cyan-600 flex-shrink-0"><Lock size={24} /></div>
                    <div>
                        <h4 className="font-bold text-slate-800 mb-2 text-lg">5. {t('Cam kết Bảo mật Thông tin', 'Privacy & Security Commitment')}</h4>
                        <p className="text-sm leading-7">{t('Chúng tôi cam kết bảo mật tuyệt đối thông tin cá nhân và dữ liệu giao dịch của khách hàng. CryptoShop không bán, chia sẻ hay cung cấp dữ liệu của bạn cho bất kỳ bên thứ ba nào, ngoại trừ trường hợp có yêu cầu bằng văn bản từ cơ quan pháp luật có thẩm quyền theo đúng quy trình tố tụng.', 
                                                             'We are committed to absolute confidentiality of customer personal information and transaction data. CryptoShop does not sell, share, or provide your data to any third party, except when requested in writing by competent legal authorities in accordance with legal proceedings.')}</p>
                    </div>
                </div>
            </div>
        </section>
